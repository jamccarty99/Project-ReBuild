    ...
    return (
      <div className="App">
        ...
        <div className="jumbotron-fluid">
          <img className='card-img' id='img-home' src='https://embed.widencdn.net/img/americanredcross/2udcdkg926/exact/home-fire-safety-recovery-header-1920x703.jpg?quality=100&u=1abbhl'/>
